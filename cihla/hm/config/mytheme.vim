if &background == 'dark'
  let s:guishade0 = "#380510" "#160106"
  let s:guishade1 = "#f21f23"
  let s:guishade2 = "#3cbf0d"
  let s:guishade3 = "#ebf21f"
  let s:guishade4 = "#457df7"
  let s:guishade5 = "#f4338d"
  let s:guishade6 = "#45dbef"
  let s:guishade7 = "#dbf8fc"
  let s:guiaccent0 = "#fc6161"
  let s:guiaccent1 = "#2aed8b"
