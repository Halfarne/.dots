if &background == 'dark'
  let s:guishade0 = "#001821"
  let s:guishade1 = "#4C8F8E"
  let s:guishade2 = "#5c4e4e" " "#03Afac"
  let s:guishade3 = "#9EBDC7"
  let s:guishade4 = "#D0C89E"
  let s:guishade5 = "#E58068"
  let s:guishade6 = "#2bcbd9" "#AFA581"
  let s:guishade7 = "#FEFEDD"
  let s:guiaccent0 = "#fc6161"
  let s:guiaccent1 = "#fa2b5a"
  let s:guiaccent2 = "#ffd4dc"
  let s:guiaccent3 = "#ff293c" "#b01d00"
  let s:guiaccent4 = "#e3bb39"
  let s:guiaccent5 = "#208490"
  let s:guiaccent6 = "#C65967"
  let s:guiaccent7 = "#0c6072"
  let s:ctermshade0 = 23
  let s:ctermshade1 = 73
  let s:ctermshade2 = 37
  let s:ctermshade3 = 152
  let s:ctermshade4 = 187
  let s:ctermshade5 = 180
  let s:ctermshade6 = 145
  ...
  let s:ctermaccent5 = 73
  let s:ctermaccent6 = 174
  let s:ctermaccent7 = 203
endif
if &background == 'light'
  let s:guishade0 = "#FCFAF1"
  let s:guishade1 = "#DCDBD3"
  let s:guishade2 = "#BBBCB4"
  let s:guishade3 = "#9B9D96"
  let s:guishade4 = "#7A7D78"
  let s:guishade5 = "#5A5E5A"
  let s:guishade6 = "#393F3B"
  let s:guishade7 = "#19201D"
  let s:guiaccent0 = "#8F4053"
  let s:guiaccent1 = "#D8965D"
  let s:guiaccent2 = "#CFA253"
  let s:guiaccent3 = "#4E8579"
  let s:guiaccent4 = "#8CB3A0"
  let s:guiaccent5 = "#4D7260"
  let s:guiaccent6 = "#786366"
  let s:guiaccent7 = "#9F5E58"
  let s:ctermshade0 = 231
  let s:ctermshade1 = 188
  let s:ctermshade2 = 188
  let s:ctermshade3 = 145
  let s:ctermshade4 = 102
  let s:ctermshade5 = 102
  let s:ctermshade6 = 59
  let s:ctermshade7 = 23
  let s:ctermaccent0 = 132
  let s:ctermaccent1 = 180
  let s:ctermaccent2 = 180
  let s:ctermaccent3 = 108
  let s:ctermaccent4 = 151
  let s:ctermaccent5 = 102
  let s:ctermaccent6 = 102
